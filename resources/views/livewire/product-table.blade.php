                    ...
                    <div
                                    ...
                                    @foreach ($products as $product)
                                        <tr wire:key="{{ $product->id }}">
                                            ...
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-3">
                                                    <span
                                                        class="py-1 px-1.5 inline-flex text-white items-center gap-x-1 text-xs font-medium">
                                                        ${{ $product->price }}
                                                    </span>
                                                </div>
                                            </td>
                                            ...
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-1.5">
                                                    <a wire:navigate wire:click="delete({{ $product->id }})"
                                                        ...
                                                        class="inline-flex items-center gap-x-1 text-sm text-red-500 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-red-500"
                                                        href="">
                                                        Delete
                                                    </a>
                                                </div>
                        ...
                        <div
                            ...
                            <div class="flex gap-2">
                                <label class="w-32 text-sm font-medium text-gray-100">Per Page</label>
