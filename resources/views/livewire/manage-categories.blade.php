                                    ...
                                    @foreach ($categories as $category)
                                        <tr wire:key="{{ $category->id }}">
                                            ...
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-3">
                                                    <span
                                                        class="text-sm text-gray-500 dark:text-neutral-500">{{ date('D M Y, H:i', strtotime($category->created_at)) }}</span>
                                                </div>
                                            </td>
                                            <td class="size-px whitespace-nowrap">
                                            ...
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-1.5">
                                                    <a class="inline-flex items-center gap-x-1 text-sm text-red-500 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-red-500"
                                                        href="#">
                                                        Delete
                                                    </a>
                                                </div>
