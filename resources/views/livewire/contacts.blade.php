            ...
            <form>
                <div class="grid gap-4 lg:gap-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                        <div>
                            <label for="hs-firstname-hire-us-2" class="block mb-2 text-sm text-gray-700 font-medium">First
                                Name</label>
                        ...
                        <div>
                            <label for="hs-lastname-hire-us-2" class="block mb-2 text-sm text-gray-700 font-medium">Last
                                Name</label>
                    ...
                    <div>
                        <label for="hs-work-email-hire-us-2" class="block mb-2 text-sm text-gray-700 font-medium">Work
                            Email</label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                        ...
                        <div>
                            <label for="hs-company-website-hire-us-2"
                                class="block mb-2 text-sm text-gray-700 font-medium">Company Website</label>
                ...
                <div class="mt-3 flex">
                    ...
                    <div class="ms-3">
                        <label for="remember-me" class="text-sm text-gray-600">By submitting this form I have read and
                            acknowledged the <a
